...
public class ScissorStack {
    ...
    public static void push(int x, int y, int width, int height, MatrixStack matrices) {
        ...
        corner2.transform(matrix);

        int transformedX = (int) Math.min(corner1.getX(), corner2.getX());
        int transformedY = (int) Math.min(corner1.getY(), corner2.getY());
        int transformedWidth = (int) (Math.max(corner1.getX(), corner2.getX()) - transformedX);
        int transformedHeight = (int) (Math.max(corner1.getY(), corner2.getY()) - transformedY);
